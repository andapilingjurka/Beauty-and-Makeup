...
<div class="container section-aboutus">
    ...
    <div class="text-content" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1000">
        ...
        <p>Plaza Cosmetics is your premier destination for indulging 
            ...
            ensures that every product we offer is carefully 
            selected to enhance your natural radiance and empower 
            yourself. <br><br>At Aquamarine, 
            we invite you to explore, discover, and celebrate the
            beauty within you.
        </p>
    </div>
</div>
...
<div class="section3-aboutus">
     <div data-aos="fade-down" data-aos-duration="1000">
        ...
        <p>
            We pride ourselves on offering fast and secure international shipping, ensuring that the quality and innovation of our 
            products reach customers worldwide.Following beauty trends has never been easier with our global shipping service. <br>
            Join us today for an unforgettable journey into the world of beauty!  
        </p>
    </div>   
